module Voxelizer
    ...
    const planeNormal = Point3{Float32}(1.0,0.0,0.0)
    ...
    function voxelizeMesh(mesh::GeometryBasics.AbstractMesh; resolution::Integer=100, padMesh = false)
        ...
        grid = zeros(Bool,gridSize[1]+2,gridSize[2]+2,gridSize[3]+2)
